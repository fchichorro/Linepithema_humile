...
metaData.species    = 'Linepithema humile'; 
metaData.species_en = 'argentine ant'; 
metaData.ecoCode.climate = {'BSk', 'Csa', 'Csb', 'Csb'};
metaData.ecoCode.ecozone = {'THp'}; 
metaData.ecoCode.habitat = {'Tf', 'Tg', 'Ta', 'Td', 'Ts', 'Ti', 'Th'};
metaData.ecoCode.embryo  = {'Tntf'}; % not sure
metaData.ecoCode.migrate = {'TT'}; % Not sure
metaData.ecoCode.food    = {'Hs', 'O'}; % not sure
metaData.ecoCode.gender  = {'Dg'};
metaData.ecoCode.reprod  = {'Ob'}; % Not sure
metaData.T_typical  = C2K(25); % K, body temp not sure
metaData.data_0     = {'ah'; 'ap'; 'am'; 'R'; 'Li'}; % maybe can also get ah_T, L0, Lh, Lp, starvation
metaData.data_1     = {}; % maybe t-Le, 

metaData.COMPLETE = 2.5; % not done using criteria of LikaKear2011

metaData.author   = {'Filipe Chichorro'};    
metaData.date_subm = [2021 04 27];              
metaData.email    = {'filipechichorro@gmail.com'};            
metaData.address  = {'University of Helsinki'};   
